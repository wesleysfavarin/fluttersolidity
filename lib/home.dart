...
import 'package:fluttersolidity/Palette.dart';
import 'package:fluttersolidity/data.dart';
    TransactionsData t1 = new TransactionsData("Enviado","OXSBJSB","123",DateFormat.jm().format(DateTime.now()));
...
Future<String> submit(String functionName,List<dynamic>args)async{
  ...
  DeployedContract contract = await loadContract();
    ...
    TransactionsData t = new TransactionsData("Recebido",result,args[0].toString(),currentTime);
    list.add(t);
     setState(() {});
         }
         else{
             TransactionsData t = new TransactionsData("Enviado",result,args[0].toString(),currentTime);
     list.add(t);
     setState(() {});
         }
     return result;
...
return response;
      ...
      body:ZStack(
            [
               ...
               VStack([
                 ...
                 "Flutter Solidity".text.xl4.white.bold.center.makeCentered().py16(),
                 (context.percentHeight*5).heightBox,
                   VxBox(
                     child: VStack([
                       "Saldo".text.gray700.xl2.semiBold.makeCentered(),
                       10.heightBox,
                       data? "\$$myData".text.xl6.bold.makeCentered().shimmer(): CircularProgressIndicator().centered()
                     ])
 ...
 hoverColor: Colors.grey,
  leading: list[index].name=="Enviado"? Icon( Icons.call_made_outlined):Icon( Icons.call_received_outlined),
